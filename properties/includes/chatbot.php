...
<div class="chatbot-window" id="chatbotWindow">
    <div class="chatbot-header">
        ...
        <div class="chatbot-header-actions">
            <button class="chatbot-minimize" id="chatMinimize" title="Minimize">
                <i class="fas fa-minus"></i>
            </button>
            <button class="chatbot-close" id="chatClose" title="Close">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendMessage(message) {
        ...
        try {
            ...
            if (data.success) {
                ...
                addMessage('bot', data.response || 'I apologize, but I\'m having trouble connecting. Please try again later.');
            }
        } catch (error) {
            hideTyping();
    ...
    function handleResize() {
        ...
        if (width < 480) {
            chatbotWindow.style.maxHeight = '75vh';
        } else if (width < 768) {
            chatbotWindow.style.maxHeight = '80vh';
        } else {
            chatbotWindow.style.maxHeight = '680px';
        }
    }
